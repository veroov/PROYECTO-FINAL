...
class SeñalMenu(QMainWindow):
    def __init__(self):
        ...
        self.btn_mat.setFixedSize(500, 50)
        self.btn_mat.setStyleSheet(estilo_botones)
        self.btn_mat.clicked.connect(self.abrir_mat_viewer)
        self.layout.addWidget(self.btn_mat, alignment=Qt.AlignHCenter)

        self.layout.addSpacing(20)

        self.btn_csv = QPushButton("Visualizar CSV")
        self.btn_csv.setFixedSize(500, 50)
        self.btn_csv.setStyleSheet(estilo_botones)
        self.btn_csv.clicked.connect(self.abrir_csv_view)
        self.layout.addWidget(self.btn_csv, alignment=Qt.AlignHCenter)

        self.layout.addSpacing(20)

        self.btn_volver = QPushButton("Volver al Login")
        self.btn_volver.setFixedSize(300, 45)
        self.btn_volver.setStyleSheet(estilo_botones)
        self.btn_volver.clicked.connect(self.volver_al_login)
        self.layout.addWidget(self.btn_volver, alignment=Qt.AlignHCenter)
